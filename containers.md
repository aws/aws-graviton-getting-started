...
| Envoy                         | https://www.envoyproxy.io/docs/envoy/latest/start/docker                                                           |                                                                                                         |
| TensorFlow with TensorFlow Serving                     | 763104351884.dkr.ecr.&lt;region&gt;.amazonaws.com/tensorflow-inference-arm64:2.19.0-cpu-py312-ubuntu22.04-sagemaker                                                          |   Refer to [Graviton TensorFlow user guide](machinelearning/tensorflow.md) for how to use; current image tag and per-region URI live at the [AWS DLC available_images](https://aws.github.io/deep-learning-containers/reference/available_images/) page. The image was renamed from `tensorflow-inference-graviton` to `tensorflow-inference-arm64`. |
| PyTorch with TorchServe                      | 763104351884.dkr.ecr.&lt;region&gt;.amazonaws.com/pytorch-inference-arm64:2.6.0-cpu-py312-ubuntu22.04-ec2                                                            | Refer to [Graviton PyTorch user guide](machinelearning/pytorch.md) for how to use; current image tag and per-region URI live at the [AWS DLC available_images](https://aws.github.io/deep-learning-containers/reference/available_images/) page. Note that Pytorch 2.6.0 is the last supported Torchserve DLC. For later Pytorch versions, consider using a [vLLM DLC](https://aws.github.io/deep-learning-containers/reference/available_images/#vllm-arm64)                  |
| Traefik                       | https://github.com/traefik/traefik/releases                                                                        |                                                                                                         |
| Flannel                       | https://github.com/flannel-io/flannel/releases                                                                     |                                                                                                         |
| Helm                          | https://github.com/helm/helm/releases/                                                                             |                                                                                                         |
| Jaeger                        | https://github.com/jaegertracing/jaeger/releases                                                                   | arm64 support added in [PR #2176](https://github.com/jaegertracing/jaeger/pull/2176)                    |
...
| containerd                    | https://github.com/containerd/containerd/releases                                                                  | nightly builds provided for arm64                                                                       |
| kube-state-metrics            | https://github.com/kubernetes/kube-state-metrics/releases                                                          | multi-arch images available at registry.k8s.io/kube-state-metrics/kube-state-metrics                    |
| cluster-autoscaler            | https://github.com/kubernetes/autoscaler/releases                                                                  | arm64 support since v1.20.0 ([PR #3714](https://github.com/kubernetes/autoscaler/pull/3714))            |
...
| Cri-o                         | https://github.com/cri-o/cri-o/blob/main/README.md#installing-crio                                                 | install instructions cover Ubuntu 20.04, 22.04, and 24.04                                               |
...
| Consul                        | https://developer.hashicorp.com/consul/install                                                                     | BSL-licensed since 2023-08-10                                                                           |
| Nomad                         | https://developer.hashicorp.com/nomad/install                                                                      | BSL-licensed since 2023-08-10                                                                           |
| Packer                        | https://developer.hashicorp.com/packer/install                                                                     | BSL-licensed since 2023-08-10                                                                           |
| Vault                         | https://developer.hashicorp.com/vault/install                                                                      | BSL-licensed since 2023-08-10; [OpenBao](https://openbao.org/) is the MPL fork                          |
| Terraform                     | https://developer.hashicorp.com/terraform/install                                                                  | arm64 support since v0.14.0 ([issue #14474](https://github.com/hashicorp/terraform/issues/14474)); BSL-licensed since 2023-08-10, [OpenTofu](https://opentofu.org/) is the MPL fork |
| Flux                          | https://github.com/fluxcd/flux/releases/                                                                           |                                                                                                         |
| Pulumi                        | https://github.com/pulumi/pulumi/releases                                                                          | arm64 support since v2.23.0 ([issue #4868](https://github.com/pulumi/pulumi/issues/4868))               |
| New Relic                     | https://docs.newrelic.com/docs/infrastructure/infrastructure-agent/linux-installation/package-manager-install/     | infrastructure agent supports aarch64                                                                   |
| Datadog - EC2                 | https://www.datadoghq.com/blog/datadog-arm-agent/                                                                  |                                                                                                         |
| Datadog - Docker              | https://hub.docker.com/r/datadog/agent                                                                             | multi-arch image supports arm64 natively                                                                |
| Dynatrace                     | https://docs.dynatrace.com/docs/ingest-from/dynatrace-oneagent/installation-and-operation/linux/installation/install-oneagent-on-linux | OneAgent supports ARM64 / Graviton on Linux                                  |
...
| metrics-server                | https://github.com/kubernetes-sigs/metrics-server/releases                                                         | docker image is multi-arch since v0.3.7                                                                 |
| AWS Copilot                   | https://github.com/aws/copilot-cli/releases/                                                                       | arm64 support as of v0.3.0; successor to the archived aws/amazon-ecs-cli                                |
...
| AWS IAM Authenticator         | https://github.com/kubernetes-sigs/aws-iam-authenticator/releases                                                  | also available via `aws eks get-token` in the AWS CLI; see [Set up kubectl and eksctl](https://docs.aws.amazon.com/eks/latest/userguide/install-kubectl.html) |
| AWS Load Balancer Controller  | https://github.com/kubernetes-sigs/aws-load-balancer-controller/releases                                           | multi-arch image; successor to the legacy AWS ALB Ingress Controller                                    |
| AWS EFS CSI Driver            | https://github.com/kubernetes-sigs/aws-efs-csi-driver/releases                                                     | arm64 support [merged 2020-08-27](https://github.com/kubernetes-sigs/aws-efs-csi-driver/pull/241)       |
| AWS EBS CSI Driver            | https://github.com/kubernetes-sigs/aws-ebs-csi-driver/releases                                                     | arm64 support [merged 2020-08-26](https://github.com/kubernetes-sigs/aws-ebs-csi-driver/pull/527)       |
| Amazon Inspector              | https://docs.aws.amazon.com/inspector/latest/user/what-is-inspector.html                                           | Uses the SSM Agent already present on EC2 for network and EC2 scanning; agent-based deep inspection is also offered. Inspector v2 must be enabled at the account or organization level — migrating from Inspector Classic without doing so creates a coverage gap. |
| Amazon CloudWatch Agent       | https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/Install-CloudWatch-Agent.html                       |                                                                                                         |
| AWS Systems Manager SSM Agent | https://docs.aws.amazon.com/systems-manager/latest/userguide/manually-install-ssm-agent-linux.html                 |                                                                                                         |
| AWS CLI                       | https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html                                      | aarch64 install instructions in the official guide; v1 and v2 both supported                            |
| FireLens for Amazon ECS       | https://github.com/aws/aws-for-fluent-bit/releases                                                                 | arm64 support since v2.9.0 ([issue #44](https://github.com/aws/aws-for-fluent-bit/issues/44))           |
