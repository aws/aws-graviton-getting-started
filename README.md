...
HAProxy  |   2.4+  | Significant performance improve for Arm64 in the move to version 2.4
...
ruby    | 3.0+ | Enable arm64 optimizations that improve perfomance by as much as 40% on included benchmarks.
