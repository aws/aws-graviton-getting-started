...
## Bazel on Linux
The [Bazel build tool](https://www.bazel.build/) now releases a pre-built binary for arm64, but as of August 2020, this is not available in their custom Redhat/Debian repos. Instead, we recommend using the [Bazelisk installer](https://github.com/bazelbuild/bazelisk/releases):
```
